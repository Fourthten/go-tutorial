...
var (
	...
	dbMaxConns     = 100
	totalWorker    = 100
	csvFile        = "/Users/fourthten/Downloads/majestic_million.csv"
	dataHeaders    = []string{
		"GlobalRank",
		"TldRank",
		"Domain",
...
func openCsvFile() (*csv.Reader, *os.File, error) {
	...
	if err != nil {
		if os.IsNotExist(err) {
			log.Fatal("file majestic_million.csv not found")
		}
		return nil, nil, err
	}
...
// 	TldRank int(11) NOT NULL,
// 	Domain varchar(255) NOT NULL,
// 	TLD varchar(255) NOT NULL,
// 	RefSubNets int(11) NOT NULL,
// 	RefIPs int(11) NOT NULL,
// 	IDN_Domain varchar(255) NOT NULL,
// 	IDN_TLD varchar(255) NOT NULL,
// 	PrevGlobalRank int(11) NOT NULL,
// 	PrevTldRank int(11) NOT NULL,
// 	PrevRefSubNets int(11) NOT NULL,
// 	PrevRefIPs int(11) NOT NULL,
// 	PRIMARY KEY (GlobalRank, TldRank)
