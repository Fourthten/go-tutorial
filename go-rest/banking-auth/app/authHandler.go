...
import (
	"encoding/json"
	"go-rest/banking-auth/dto"
	"go-rest/banking-auth/service"
...
/*
	Sample URL string
	http://localhost:8181/auth/verify?token=aaaa.bbbb.cccc&routeName=GetCustomer&customer_id=2000&account_id=95400
*/
